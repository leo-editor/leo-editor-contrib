"@+leo-ver=5-thin
"@+node:maphew.20101201124731.3123: * @file filetype.vim
"@@language vim
...
syn match   Comment         "\* .*$"hs=s+1  containedin=leoHeadline

highlight leoHeadline guifg=grey
