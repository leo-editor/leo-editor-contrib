#@+leo-ver=5-thin
#@+node:ekr.20110602070710.3452: * @file EditAttributes.py
#@+<< docstring >>
#@+node:ekr.20110602070710.3453: ** << docstring >>
...
#@+others
#@+node:ekr.20110602070710.3456: ** init
def init ():
...
#@+node:ekr.20110602070710.3457: ** class AttrEditor
class AttrEditor:
    #@+others
    #@+node:ekr.20110602070710.3458: *3* __init__
    ...
    #@+node:ekr.20110602070710.3459: *3* buttonCommands
    def buttonCommands( self, name ):
        if name == 'Add Attribute': return self.add() 
            ...
            self.dialog.destroy()
    #@+node:ekr.20110602070710.3460: *3* _mkGui
    def _mkGui( self, frame ):
        ...
        if bk:
            lb.setvalue( bk[ 0 ] )
            self.selcommand()
    #@+node:ekr.20110602070710.3461: *3* setText
    ...
    #@+node:ekr.20110602070710.3462: *3* selcommand
    def selcommand( self ):
        cs = self.lb.getcurselection()
        if len( cs ) != 0: cs = cs[ 0 ]
        else: return
    ...
    #@+node:ekr.20110602070710.3463: *3* add
    def add( self ):
        ...
        self.tx.delete( '1.0', 'end' )
    #@+node:ekr.20110602070710.3464: *3* rmv
    def rmv( self ):
        ...
        self.tx.delete( '1.0', 'end' )  
    #@-others
#@+node:ekr.20110602070710.3465: ** newCreateCanvas
