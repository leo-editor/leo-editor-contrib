//@+leo-ver=4-thin
//@+node:orkman.20050203100526:@thin leoEditorKit.java
//@@language java
...
public final class leoEditorKit extends StyledEditorKit{
    ...
    //@    @+others
    //@+node:orkman.20050203102505:leoEditorKit
    ...
    //@-node:orkman.20050203102505:leoEditorKit
    //@+node:orkman.20050203101056:clone
    public Object clone(){
    ...
    //@nonl
    //@-node:orkman.20050203101056:clone
    //@+node:orkman.20050221101651:createDefaultDocument
    ...
    //@nonl
    //@-node:orkman.20050221101651:createDefaultDocument
    //@+node:orkman.20050203101056.5:getContentType
    ...
    //@nonl
    //@-node:orkman.20050203101056.5:getContentType
    //@+node:orkman.20050203101056.6:getViewFactory
    ...
    //@nonl
    //@-node:orkman.20050203101056.6:getViewFactory
    //@+node:orkman.20050203102931:class LeoViewFactory
    ...
    //@nonl
    //@-node:orkman.20050203102931:class LeoViewFactory
    //@+node:orkman.20050221102149:class LeoDefaultStyledDocument
    ...
    //@-node:orkman.20050221102149:class LeoDefaultStyledDocument
    //@+node:orkman.20050210163759:interface ColorDeterminer
    ...
    //@-node:orkman.20050210163759:interface ColorDeterminer
    //@+node:orkman.20050203101946:class LeoView
    ...
    //@@c
        ...
        //@    @+others
        //@+node:zorcanda!.20050308104129:defineRegions
        ...
        //@-node:zorcanda!.20050308104129:defineRegions
        //@+node:zorcanda!.20050308171415:setTokenType
        ...
        //@nonl
        //@-node:zorcanda!.20050308171415:setTokenType
        //@+node:zorcanda!.20050331110119:drawSelectedText
        ...
        //@nonl
        //@-node:zorcanda!.20050331110119:drawSelectedText
        //@+node:orkman.20050210164645:drawUnselectedText
        ...
        //@-node:orkman.20050210164645:drawUnselectedText
        //@+node:orkman.20050210164058:drawTokens
        ...
        //@nonl
        //@-node:orkman.20050210164058:drawTokens
        //@+node:orkman.20050210162339:paintNumbers
        private final void paintNumbers( final Graphics g, final LeoNumberLabel lnl ){
            ...
            try{
                ...
                //@+node:orkman.20050210163102:<< count and build numbers >>
                //final Document doc = getDocument();
                ...
                //@+node:zorcanda!.20050309121759:<< determine visible numbers >>
                ...
                //@+node:orkman.20050210162521:<< determine current line >>
                /*JTextPane _jtp = (JTextPane)getContainer();
                int pos = _jtp.getCaretPosition();
                pos = txt.substring( 0, pos ).lastIndexOf( "\n" );
                if( pos == -1 ) pos = 0;
                ...
                */
                ...
                //@+node:orkman.20050210163314:<< paint colored numbers >>
        ...
        //@-node:orkman.20050210162339:paintNumbers
        //@+node:orkman.20050210163539:class Token
        final class Token{
        ...
        //@nonl
        //@-node:orkman.20050210163539:class Token
        //@+node:zorcanda!.20050921114426:class LeoTokenizer
    ...
    //@-node:orkman.20050203101946:class LeoView
    //@+node:orkman.20050209152935:class LeoNumberLabel
